...
parser.add_argument('--poses-dir', type=str, required=True)
...
device = "cuda:0"
pretrained_model_name_or_path ="./model/stable-diffusion-2-1-base"
image_encoder_path = "./model/dinov2-giant"
...
for i in range(num_image):
    ...
    pose_dir = args.poses_dir + image_path[len(args.images_dir):image_path.rfind('/')]
    pose_dir = os.path.join(pose_dir, image_name + '.png')
    # inference
    num_samples = 1
    image_size = (512, 512)
    s_img_path = image_path
    target_pose_img = pose_dir
